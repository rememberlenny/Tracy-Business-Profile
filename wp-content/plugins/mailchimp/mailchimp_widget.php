...
?>
		<div class="small-3 columns mc_signup_submit">
			<input type="submit" name="mc_signup_submit" id="mc_signup_submit" value="<?php echo esc_attr(get_option('mc_submit_text')); ?>" class="button prefix fs08em" style="font-size: .6em;
height: 2.65em;
padding-top: .3em;"/>
