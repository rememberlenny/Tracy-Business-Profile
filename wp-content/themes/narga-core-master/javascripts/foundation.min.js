...
(function($) {
    ...
    if (typeof jQuery == "undefined" && typeof Zepto == "undefined" && typeof $ == "function") libFuncName = $;
        ...
        t.matchMedia = t.matchMedia || function(e, t) {
            ...
            response_obj: function(e, t) {
                for (var n = 0, r = t.length; n < r; n++) if (typeof t[n] == "function") return t[n]({
    ...
    function(e, t, n, r) {
        ...
        Foundation.libs.clearing = {
            ...
            settings: {
                templates: {
                    viewing: '<a href="#" class="clearing-close">×</a><div class="visible-img" style="display: none"><img src="//:0"><p class="clearing-caption"></p><a href="#" class="clearing-main-prev"><span></span></a><a href="#" class="clearing-main-next"><span></span></a></div>'
                },
    ...
    function(e, t, n, r) {
        ...
        var i = function() {}, s = function(i, s) {
            ...
            c.children().first().addClass(s.active_slide_class), f.update_slide_number = function(t) {
                ...
                f.build_markup(), s.timer && (g = f.create_timer(), g.start()), m = new a(c), s.animation === "slide" && (m = new u(c)), l.on("click", "." + s.next_class, f.next), l.on("click", "." + s.prev_class, f.prev), l.on("click", f.toggle_timer), l.on("touchstart.fndtn.orbit", function(e) {
                ...
                }), e(n).on("click", "[data-orbit-link]", f.link_custom), e(n).on("click", "[data-orbit-slide]", f.link_bullet), e(t).on("resize", f.compute_dimensions), e(t).on("load", f.compute_dimensions), c.trigger("orbit:ready")
            }, f.init()
        }, o = function(e, t, n) {
            var r = this,
                i = t.timer_speed,
            ...
            this.next = function(e, n, r) {
                ...
                n.css("marginLeft", "-100%"), n.animate({
                    marginLeft: "0%"
                }, t, "linear", function() {
                    e.css("marginLeft", "100%"), r()
                })
    ...
    function(e, t, n, r) {
        ...
        Foundation.libs.reveal = {
            ...
            open: function(t, n) {
                if (t) if (typeof t.selector != "undefined") var r = e("#" + t.data("reveal-id"));
                else {
                    var r = e(this.scope);
                    n = t
    ...
    function(e, t, n) {
        ...
        Foundation.libs.section = {
            ...
            toggle_active: function(t) {
                ...
                !u.deep_linking && s.length > 0 && t.preventDefault(), t.stopPropagation(), i.hasClass(r.settings.active_class) ? !u.one_up && (r.small(o) || r.is_vertical_nav(o) || r.is_horizontal_nav(o) || r.is_accordion(o)) && i.removeClass(r.settings.active_class) : (a.removeClass(r.settings.active_class), i.addClass(r.settings.active_class), r.resize(i.find(r.settings.section_selector).not("[" + r.settings.resized_data_attr + "]"), !0)), u.callback()
            },
        ...
        Foundation.libs.topbar = {
                ...
                e(this.scope).off(".fndtn.topbar").on("click.fndtn.topbar", ".top-bar .toggle-topbar, [data-topbar] .toggle-topbar", function(i) {
                    ...
                    if (n.breakpoint()) {
                        ...
                        i.data("index", i.data("index") + 1), a.addClass("moved"), n.rtl ? (s.css({
                            ...
                            left: 100 * i.data("index") + "%"
                        })), i.css("height", n.outerHeight(r.siblings("ul"), !0) + n.outerHeight(o, !0))
                    }
                    ...
                    i.data("index", i.data("index") - 1), n.rtl ? (o.css({
                        ...
                        left: 100 * i.data("index") + "%"
                    })), i.data("index") === 0 ? i.css("height", "") : i.css("height", n.outerHeight(a, !0) + n.outerHeight(s, !0)), setTimeout(function() {
                        u.removeClass("moved")
                    }, 300)
                })
            },
            ...
            assemble: function() {
                ...
                this.settings.$section.detach(), this.settings.$section.find(".has-dropdown>a").each(function() {
                    ...
                    t.settings.custom_back_text == 1 ? s.find("h5>a").html("« " + t.settings.back_text) : s.find("h5>a").html("« " + n.html()), r.prepend(s)
    ...
    function(e, t, n, r) {
        ...
        Foundation.libs.abide = {
            ...
            validate: function(t, n) {
                ...
                while (i--) if (!r[i] && /submit/.test(n.type)) return this.settings.focus_on_invalid && t[i].focus(), s.trigger("invalid"), e(t[i]).closest("form").attr("data-invalid", ""), !1;
