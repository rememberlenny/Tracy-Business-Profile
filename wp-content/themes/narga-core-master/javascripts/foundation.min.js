...
function(e, t, n, r) {
    ...
    Foundation.libs.forms = {
        ...
        append_custom_markup: function(t, n) {
            var r = e(n).addClass("hidden-field"),
                i = r.attr("type"),
    ...
    Foundation.libs.joyride = {
        ...
        pos_phone: function(t) {
            var n = this.outerHeight(this.settings.$next_tip),
                ...
                i = this.
                outerHeight(this.settings.$target),
        ...
        show_modal: function() {
            this.settings.$next_tip.data("closed") || (e(".joyride-modal-bg").length < 1 && e("body").append(this.settings.template.modal).show(), /pop/i.test(this.settings.tipAnimation) ? e(".joyride-modal-bg").show() : e(".joyride-modal-bg").fadeIn(this.settings.tipAnimationFadeSpeed))
        },
        expose: function() {
            var n, r, i, s, o = "expose-" + Math.floor(Math.random() * 1e4);
            ...
            }, i.css("z-index", n.css("z-index") * 1 + 1), s.position == "static" && i.css("position", "relative"), i.data("expose-css", s), r.css({
                top: i.offset().top,
                left: i.offset().left,
                width: this.outerWidth(i, !0),
                height: this.outerHeight(i, !0)
        ...
        startTimer: function() {
            ...
            }), this.settings.timer > 0 && clearTimeout(this.settings.automate), this.settings.modal && this.settings.expose && this.un_expose(), this.settings.$next_tip.data("closed", !0), e(".joyride-modal-bg").hide(), this.settings.$current_tip.hide(), this.settings.postStepCallback(this.settings.$li.index(), this.settings.$current_tip), this.settings.postRideCallback(this.settings.$li.index(), this.settings.$current_tip)
        },
        outerHTML: function(e) {
            return e.outerHTML || (new XMLSerializer).serializeToString(e)
        },
    ...
    Foundation.libs.topbar = {
        ...
        assemble: function() {
            ...
            this.settings.$section.detach(), this.settings.$section.find(".has-dropdown>a").each(function() {
                ...
                t.settings.custom_back_text == 1 ? i.find("h5>a").html("« " + t.settings.back_text) : i.find("h5>a").html("« " + n.html()), r.prepend(i)
