<div class="column ">
    ...
    <ul class="text-center large-block-grid-5">
      ...
      <li>
        <img src="<?php bloginfo('url') ?>/wp-content/uploads/2013/06/supper.png" alt="">
        <p><a style="font-size:.7em;" href=""> Supper Defender IV</a></p>
      </li>
      <li>
        <img src="<?php bloginfo('url') ?>/wp-content/uploads/2013/06/driving.png" alt="">
        <p><a style="font-size:.7em;" href=""> Driving School</a></p>
      </li>
      <li>
        <img src="<?php bloginfo('url') ?>/wp-content/uploads/2013/06/anime.png" alt="">
        <p><a style="font-size:.7em;" href=""> Anime Beauty</a></p>
      </li>
      <li>
        <img src="<?php bloginfo('url') ?>/wp-content/uploads/2013/06/hider.png" alt="">
