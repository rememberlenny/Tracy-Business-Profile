...
require_once('atriangle-functions/submenu-menu.php');
require_once('atriangle-functions/admin-options.php');
...
if (!function_exists('narga_header')) :  
    function narga_header() {
        echo '<div id="site-header" class="row background-image">
            <header id="header" class="large-12 columns mt2em" role="banner">
            </header>
            </div>';
    }  
endif;
